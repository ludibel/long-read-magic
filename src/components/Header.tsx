...
export function Header() {
  ...
  const shouldMakeHeaderTransparent = currenPath === '/' || currenPath === "/genomes";
  ...
  return (
      <header className={clsx("fixed top-0 w-full z-[1]", !scrolled && shouldMakeHeaderTransparent ? "bg-transparent text-white fill-current" : "bg-white text-gray-900 shadow-md")}>
